...
export default function AddIdeaModal({ tripId, tripStartDate, tripEndDate, isOpen, onClose, onIdeaAdded, defaultProposalId }: AddIdeaModalProps) {
    ...
    try {
      ...
      const response = await fetch('/api/ideas', {
        ...
        body: JSON.stringify({
          ...
          proposalId: defaultProposalId || null,
        }),
      });
              ...
              {selectedFiles.length > 0 && (
                <div className="flex gap-2 overflow-x-auto mt-2 pb-1">
                  {selectedFiles.map((file, index) => (
                    <div key={index} className="relative flex-shrink-0 w-20 h-20 rounded-lg border border-gray-200 dark:border-gray-600">
                      <img
